...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.startstart = self.start.clone()
        self.endend = self.end.clone()
    ...
    def clone(self):
        ...
        self.clonenumbers = self.clonenumbers + 1
    ...
    def slope(self):
        ...
        if (self.end.x - self.start.x) is 0:
            return math.inf
    ...
    def reset(self):
        ...
        self.start = self.startstart
        self.end = self.endend
